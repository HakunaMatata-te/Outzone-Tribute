...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_LASER_LEFT][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_LASER_LEFT][COLLIDER_PLAYER_SHOT] = true;
	matrix[COLLIDER_LASER_LEFT][COLLIDER_ENEMY_SHOT] = true;
	...
	matrix[COLLIDER_LASER_RIGHT][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_LASER_RIGHT][COLLIDER_PLAYER_SHOT] = true;
	matrix[COLLIDER_LASER_RIGHT][COLLIDER_ENEMY_SHOT] = true;
