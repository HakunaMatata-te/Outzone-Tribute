...
Enemy_Yellow_Infantery::Enemy_Yellow_Infantery(int x, int y, uint typemove) : Enemy(x, y, typemove)
{
	Idle_1.PushBack({ 499, 477, 25, 32 });
	Idle_2.PushBack({ 555, 472, 29, 30 });
	Idle_3.PushBack({ 385, 597, 24, 31 });
	Idle_4.PushBack({ 654, 517, 23, 31 });
	Idle_5.PushBack({ 501, 517, 23, 32 });
	Idle_6.PushBack({ 552, 603, 27, 32 });
...
void Enemy_Yellow_Infantery::death(){
